    ...
    switch(sc)
        ...
        case 'Cassini'
            ...
            cassiniSpice = {fullfile(sc, 'cas_2004_v26.tm') ...
                            ...
                            fullfile(sc, 'cas_2007_v24.tm') ...
                            fullfile(sc, 'cas_2008_v22.tm') ...
                            fullfile(sc, 'cas_2009_v19.tm') ...
                            fullfile(sc, 'cas_2010_v18.tm') ...
                            fullfile(sc, 'cas_2011_v17.tm') ...
                            fullfile(sc, 'cas_2012_v14.tm') ...
                            fullfile(sc, 'cas_2013_v12.tm') ...
                            fullfile(sc, 'cas_2014_v08.tm') ...
                            fullfile(sc, 'cas_2015_v08.tm') ...
                            fullfile(sc, 'cas_2016_v06.tm') ...
