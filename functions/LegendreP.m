...
function Pnm = LegendreP(n, m, theta, UNNORM)  % n ( or l) = degree m = order
    ...
    elseif (n == 3)
        ...
        elseif (m == 1); Pnm = (3/4) * (3 + 5*cos(2*theta)) .* sin(theta);
    ...
    elseif (n == 4)
        ...
        elseif (m == 1); Pnm = (5/8) * (9*cos(theta) + 7*cos(3*theta)) .* sin(theta);
    ...
    elseif (n == 5)
        ...
        elseif (m == 1); Pnm = (15/64) * (15 + 28*cos(2*theta) + 21*cos(4*theta)) .* sin(theta);
    ...
    elseif (n == 6)
        ...
        elseif (m == 1); Pnm = (21/128) * (50*cos(theta) + 45*cos(3*theta) + 33*cos(5*theta)) .* sin(theta);
    ...
    elseif (n == 7)
        ...
        elseif (m == 1); Pnm = (7/512) * (350 + 675*cos(2*theta) + 594*cos(4*theta) + 429*cos(6*theta)) .* sin(theta);
    ...
    elseif (n == 8)
        ...
        elseif (m == 1); Pnm = (9/1024) * (1225*cos(theta) + 11*(105*cos(3*theta) + 91*cos(5*theta) + 65*cos(7*theta))) .* sin(theta);
    ...
    elseif (n == 9)
        ...
        elseif (m == 1); Pnm = (45/16384) * (2205 + 4312*cos(2*theta) + 4004*cos(4*theta) + 3432*cos(6*theta) + 2431*cos(8*theta)) .* sin(theta);
    ...
    elseif (n == 10)
        ...
        elseif (m == 1);  Pnm = (55/32768) * (7938*cos(theta) + 13*(588*cos(3*theta) + 540*cos(5*theta) + 459*cos(7*theta) + 323*cos(9*theta))) .* sin(theta);
        elseif (m == 2);  Pnm = (495/16384) * (8085 + 15288*cos(2*theta) + 12740*cos(4*theta) + 8840*cos(6*theta) + 4199*cos(8*theta)) .* sin(theta).^2;
        elseif (m == 3);  Pnm = (6435/1024) * (1617*cos(theta) + 1323*cos(3*theta) + 833*cos(5*theta) + 323*cos(7*theta)) .* sin(theta).^3;
