...
function dPnm = dLegendreP(n, m, theta, UNNORM)
    ...
    elseif (n == 4)
        ...
        elseif (m == 3); dPnm = (105) * (1 + 2*cos(2*theta)) .* sin(theta).^2;  
    ...
    elseif (n == 5)
        ...
        elseif (m == 3); dPnm = (315/8) * (17*cos(theta) + 15*cos(3*theta)) .* sin(theta).^2;
    ...
    elseif (n == 6)
        ...
        elseif (m == 3); dPnm = (945/8) * (7 + 14*cos(2*theta) + 11*cos(4*theta)) .* sin(theta).^2;
    ...
    elseif (n == 7)
        ...
        elseif (m == 3); dPnm = (315/128) * (1442*cos(theta) + 1397*cos(3*theta) + 1001*cos(5*theta)) .* sin(theta).^2;
    ...
    elseif (n == 8)
        ...
        elseif (m == 3); dPnm = (10395/64) * (21 + 42*cos(2*theta) + 39*cos(4*theta) + 26*cos(6*theta)) .* sin(theta).^2;
    ...
    elseif (n == 9)
        ...
        elseif (m == 3); dPnm = (10395/1024) * (1197*cos(theta) + 13*(91*cos(3*theta) + 81*cos(5*theta) + 51*cos(7*theta))) .* sin(theta).^2;
    ...
    elseif (n == 10)
        ...
        elseif (m == 3);  dPnm = (6435/4096) * (98*cos(2*theta) + 352*cos(4*theta) + 621*cos(6*theta) + 544*cos(8*theta) - 1615*cos(10*theta));
